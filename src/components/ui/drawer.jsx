...
const DrawerContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      {...props}>
      <div
        className="tailwind.config.jsmx-auto tailwind.config.jsmt-4 tailwind.config.jsh-2 tailwind.config.jsw-[100px] tailwind.config.jsrounded-full tailwind.config.jsbg-muted" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
))

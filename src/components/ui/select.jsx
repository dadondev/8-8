...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown
        className="tailwind.config.jsh-4 tailwind.config.jsw-4 tailwind.config.jsopacity-50" />
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      <SelectPrimitive.Viewport
        className={cn("tailwind.config.jsp-1", position === "popper" &&
...
const SelectLabel = React.forwardRef(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "tailwind.config.jspy-1.5 tailwind.config.jspl-8 tailwind.config.jspr-2 tailwind.config.jstext-sm tailwind.config.jsfont-semibold",
      className
    )}
    {...props} />
))
